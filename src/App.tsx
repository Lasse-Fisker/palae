...
import church from "./Illustrationer/Tag1.png";
import garden from "./Illustrationer/Tag3.png";
import palace from "./Illustrationer/Tag2.png";
...
const locations: Location[] = [
  ...
  },
  {
    ...
    lat: 56.15223,
    img: church,
    address: "Kirkekirkevej 13, 8220 Branrand",
  },
  {
          ...
          <div className="flex gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <ul className="ml-4 flex list-disc flex-col gap-2">
                <li>Kirkens parkering</li>
                <li>Duelandsvej (parallelt med Silkeborgvej</li>
                <li>Årslev Markvej (bag palæet)</li>
              </ul>
            </div>
          </div>
        </Section>
